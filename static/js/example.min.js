...
dragula([$('left-defaults'), $('middle-defaults'), $('right-defaults')], {
revertOnSpill: true});
dragula([$('left-copy'), $('middle-copy'), $('right-copy')], { copy: true });
dragula([$('left-events'), $('middle-events'), $('right-events')])
  .on('drag', function (el) {
...
dragula([$('left-rollbacks'), $('middle-rollbacks'), $('right-rollbacks')], { revertOnSpill: true });
dragula([$('left-lovehandles'), $('middle-lovehandles'), $('right-lovehandles')], {
